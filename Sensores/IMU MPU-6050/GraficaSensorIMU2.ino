...
String json_data = "AceleracionXYZ," + (String)accel_x + "," + (String)accel_y + "," + (String)accel_z + ",\"GiroscopioXYZ\"," + (String)accel_t_gyro.value.x_gyro + "," + (String)accel_t_gyro.value.y_gyro + "," + (String)accel_t_gyro.value.z_gyro + ",\"TempC\"," + (String)dT + "";
